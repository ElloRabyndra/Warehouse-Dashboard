...
const Header = () => {
  ...
  return (
    <div className="sm:flex flex-row-reverse items-center justify-between mb-6 space-y-2">
      <div className="flex items-center space-x-4">
        {/* Real-time indicator */}
        <div className="flex items-center space-x-2">
          {indicator.icon}
          <span
            className={`${indicator.bgColor} ${indicator.textColor} text-sm font-medium px-2 py-1 rounded-full`}
          >
            {indicator.text}
          </span>
        </div>
